    ...
    input.onchange = (e) => {
      ...
      if (file) {
        ...
        if (!['image/jpeg', 'image/jpg', 'image/png', 'application/pdf'].includes(file.type)) {
          alert('Hanya file JPG/PNG/PDF yang diperbolehkan');
          return;
        }
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content-surat" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body-surat">
          ...
          <div className="form-group-surat">
            <label>Unggah Foto Surat (Maks. 5MB - JPG/PNG/PDF)</label>
            <div className="upload-box">
              {formData.uploadFile ? (
                ...
                <button type="button" className="upload-file-btn-surat" onClick={handleFileUpload}>
                  ...
                  <span style={{ fontSize: '11px', color: '#94a3b8', marginTop: '4px' }}>JPG, PNG, atau PDF (Maks. 5MB)</span>
                </button>
              )}
            </div>
          </div>
