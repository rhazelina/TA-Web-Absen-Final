...
const SubjectsModal = ({ isOpen, onClose, scheduleImage = null }) => {
  ...
  return (
    <div className="all-riwayat-modal-overlay" onClick={onClose}>
      <NavbarPengurus />
      <div className="modal-wrapper-custom" onClick={(e) => e.stopPropagation()}>
        <div className="modal-absen-detail" style={{ width: '100%', maxWidth: '100%', display: 'flex', flexDirection: 'column' }}>
          <div className="modal-subject-header">
            <button onClick={onClose} className="back-btn" style={{ marginRight: '16px' }}>
              <ArrowLeft size={24} />
            </button>
          ...
          <div className="modal-content-scrollable">
            {scheduleImage ? (
              ...
              <div className="modal-empty-state">
                ...
                <h3 className="empty-title">Belum Ada Jadwal</h3>
...
// Line Chart Component - Menggantikan Bar Chart
const LineChart = ({ data }) => {
  ...
  return (
    <div className="chart-container-box" style={{ width: '100%', height: '400px' }}>
      <div className="chart-header">
        <div className="chart-title-group">
          ...
          <div>
            <h3 className="chart-title">Tren Kehadiran</h3>
            <p className="chart-subtitle">Statistik Bulanan</p>
          </div>
        </div>
        {/* Legend */}
        <div style={{ display: 'flex', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '12px', fontWeight: '600', color: '#6b7280' }}>Hadir</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div style={{ width: '12px', height: '12px', borderRadius: '50%', background: '#ef4444' }}></div>
            <span style={{ fontSize: '12px', fontWeight: '600', color: '#6b7280' }}>Tidak Hadir</span>
          </div>
        </div>
      </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{
                ...
                fontWeight: 'bold',
                color: '#1f2937'
              }}>{hoveredPoint.total} kehadiran</span>
            </div>
          </div>
        )}
      </div>
...
const DonutChart = ({ data }) => {
  ...
  return (
    <div className="chart-container-box" style={{ height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <h3 className="chart-title" style={{ marginBottom: '24px', alignSelf: 'flex-start' }}>Status Harian</h3>
      ...
      <div className="modal-wrapper-custom" onClick={(e) => e.stopPropagation()}>
        <div className="modal-absen-detail" style={{ width: '100%', maxWidth: '100%', display: 'flex', flexDirection: 'column' }}>
          <div className="modal-subject-header">
            ...
            <div className="subject-title">
              <h2>Info Akun</h2>
              <div className="subject-class">Pengaturan Profil</div>
            </div>
          </div>
          ...
          <div className="modal-content-scrollable">
            ...
            <div className="profile-details-group">
              ...
              <div className="profile-detail-item">
                <div className="profile-detail-label">Nomor Induk</div>
